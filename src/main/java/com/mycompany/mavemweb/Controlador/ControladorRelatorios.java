...
public class ControladorRelatorios {
    ...
    public Tabconta razaoPorConta(Tabconta ct, List<Tablanc> lancPorData, Double saldoI) {
        ...
        //Por iso que também passamos por parâmetro o lancPorData, porque ele depende de cada conta.
    ...
    public void balancete() {
        ...
        for (Tabconta conta : balancetes) {
            System.out.println("Balan: " + conta.toString());
        }
