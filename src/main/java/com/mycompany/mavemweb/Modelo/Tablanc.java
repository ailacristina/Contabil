 ...
 */
package com.mycompany.mavemweb.Modelo;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Tablanc.updateDataLanc", query = "UPDATE Tablanc t SET t.dataLanc = :dataLanc WHERE t.dataLanc = :dataLanc"),
...
public class Tablanc implements Serializable,Comparable<Tablanc> {
    ...
    public static final String updateData = "Tablanc.updateDataLanc";
